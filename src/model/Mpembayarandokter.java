...
import view.bayarasdokter;
import javax.swing.table.DefaultTableModel;

public class Mpembayarandokter extends bayarasdokter {
    ...
    public static void tabel(){
        ...
        try{
            ...
            query = "SELECT pembayaran.no_bayar, pasien.nama_pasien, obat.nama_obat, obat.harga, "
                    ...
                    + "JOIN pembayaran ON pembayaran.no_resep = resep.no_resep WHERE dokter.id_dokter = '"+TIdDokter.getText()+"'"
     ...
     public static void fungsiCari(){
         ...
         try{
             ...
             query = "SELECT pembayaran.no_bayar, pasien.nama_pasien, obat.nama_obat, obat.harga, dokter.biaya_periksa, "
                     ...
                     + "WHERE pembayaran.no_bayar LIKE '%"+TCari.getText()+"%' AND dokter.id_dokter = '"+TIdDokter.getText()+"'"
                     + "OR pasien.nama_pasien LIKE '%"+TCari.getText()+"%' AND dokter.id_dokter = '"+TIdDokter.getText()+"'"
                     + "OR obat.nama_obat LIKE '%"+TCari.getText()+"%' AND dokter.id_dokter = '"+TIdDokter.getText()+"'"
                     + "OR dokter.biaya_periksa LIKE '"+TCari.getText()+"' AND dokter.id_dokter = '"+TIdDokter.getText()+"'"
                     + "OR pembayaran.status LIKE '%"+TCari.getText()+"%' AND dokter.id_dokter = '"+TIdDokter.getText()+"'"
